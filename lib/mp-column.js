...
(0, _mjmlValidator.registerDependencies)({
    ...
    'mj-group': ['mp-column'],
    'mp-column': ['mp-text', 'mp-image', 'mj-accordion', 'mj-button', 'mj-carousel', 'mj-divider', 'mj-image', 'mj-raw', 'mj-social', 'mj-spacer', 'mj-table', 'mj-text']
});
...
var MpColumn = (_temp = _class = function (_MjColumn) {
    ...
    (0, _createClass3.default)(MpColumn, [{
        ...
        value: function render() {
            var classesName = this.getColumnClass() + ' mj-outlook-group-fix';
