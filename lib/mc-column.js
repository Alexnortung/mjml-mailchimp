...
(0, _mjmlValidator.registerDependencies)({
    ...
    'mj-group': ['mc-column'],
    'mc-column': ['mc-text', 'mc-image', 'mj-accordion', 'mj-button', 'mj-carousel', 'mj-divider', 'mj-image', 'mj-social', 'mj-spacer', 'mj-table', 'mj-text']
});

var McColumn = (_temp = _class = function (_MjColumn) {
    (0, _inherits3.default)(McColumn, _MjColumn);

    function McColumn() {
        (0, _classCallCheck3.default)(this, McColumn);
        return (0, _possibleConstructorReturn3.default)(this, (McColumn.__proto__ || (0, _getPrototypeOf2.default)(McColumn)).apply(this, arguments));
    }

    (0, _createClass3.default)(McColumn, [{
        key: 'renderColumn',
